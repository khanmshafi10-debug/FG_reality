...
// 1. Remove previous dark showcase sections
const carouselStart = html.indexOf('<style id="fgReelsCarouselCSS">');
if (carouselStart > -1) {
...
// All 24 Projects Data without card numbers
const allProjects = [
  // WATERFRONT & ISLANDS
  {
    sec: 'waterfront',
...
// Helper: Render card without number tag (Light Theme)
...
// Helper: Render carousel reel card without number tag (Light Theme)
...
@media (max-width: 768px) {
  ...
  .pvSecTitle { font-size: 1.8rem; }
  .pvGrid { grid-template-columns: 1fr; gap: 24px; }
...
if (insertIdx > -1) {
  ...
  console.log('✨ SUCCESS: Converted 24 projects showcase to Light Theme without numbers on cards!');
} else {
