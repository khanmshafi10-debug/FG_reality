...
// 24 Projects - Balanced into 4 Sections of 6 Cards Each
const allProjects = [
...
@media (max-width: 1024px) {
  .pvGrid { grid-template-columns: repeat(2, 1fr); }
}
...
if (insertIdx > -1) {
  ...
  console.log('✨ SUCCESS: Balanced all 4 sections into exactly 6 cards each (100% full 3-column rows with zero blank slots)!');
} else {
